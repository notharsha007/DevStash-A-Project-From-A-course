---
description: Run a research task to generate documentation from a prompt file in context/research/
---
...
Execute a research task based on an argument provided by the user.
...
- This workflow produces DOCUMENTATION only
- Do NOT modify source code files
- Do NOT create branches or commits
- Output should go to `/docs/` unless otherwise specified in the prompt file
