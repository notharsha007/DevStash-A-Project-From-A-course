...
- **2026-04-07** — Completed UX Landing Page Improve — Aligned landing page theme with the dashboard: neutral bg-background replacing blue-tinted gradient, font-bold sans-serif headings replacing font-serif, all buttons unified to shadcn default variant (bg-primary), card border radius changed from rounded-[2rem] to rounded-xl, and opacity/blue-tint tokens replaced with solid card/border tokens throughout all homepage components
